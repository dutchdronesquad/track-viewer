...
import { getDesignTexturePaths } from "../assets/texture-paths";
...
/**
 * Design-scoped replacement for the editor's whole-catalog eager preload:
 * only warms textures the given shapes actually reference, resolved
 * through assetResolver so a non-root asset prefix is respected.
 */
