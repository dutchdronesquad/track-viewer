//
// Copy of src/components/canvas/preview3d/items/TrackItem3D.tsx threaded
// with an assetResolver prop, dispatched down to the texture-using leaf
// components (Gate3D, Tower3D, Flag3D, Ladder3D, DiveGate3D, Barrier3D —
// package-local copies). The remaining leaf components (Cone3D, Label3D,
// StartFinish3D, RaceLine3D) have no texture/store coupling and are reused
