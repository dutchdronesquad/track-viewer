//
// Copy of src/components/canvas/preview3d/items/DiveGate3D.tsx with every
...
import type { DiveGateShape } from "../../types";
...
function ArchDiveGate3D({
  ...
  const [sideTexture, topTexture] = useTexture([
    assetResolver(visual.banner.sideTexture),
    assetResolver(visual.banner.topTexture),
  ]) as THREE.Texture[];
