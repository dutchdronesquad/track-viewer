...
import {
  ...
  getViewerPolylineZRange,
  getViewerPrimaryPolylineId,
} from "../design-derived";
import { ShapeNode } from "./ShapeNode";

export interface TrackViewer2DHandle {
  getStage: () => KonvaStage | null;
  fitToWindow: () => void;
}

export interface TrackViewer2DProps {
  design: TrackDesign;
...
const TrackViewer2D = memo(
  forwardRef<TrackViewer2DHandle, TrackViewer2DProps>(function TrackViewer2D(
    {
      design,
      unitSystem = "metric",
      theme = "light",
    ...
    const primaryPolylineId = useMemo(
      () => getViewerPrimaryPolylineId(designShapes),
      [designShapes]
    );
      ...
      >
        ...
        >
          <div className="flex flex-wrap items-center gap-x-2 gap-y-1">
            ...
            <span>{tCanvas.grid(gridLabel)}</span>
            <span className="text-border">·</span>
